/* assignment.c - a lexical analyzer system for simple
...
int main() {
    ...
    if ((in_fp = fopen("front.in", "r")) == NULL)
        ...
        do {
            ...
            }else if (charClass == EOF) {printf("Next token is: -1, Next lexeme is EOF\n");break;
            }else{
                lex();
...
void term() {
    ...
    while ((nextToken == MULT_OP || nextToken == DIV_OP) && charClass != NEXTLINE) {
        lex();
        factor();
        if (restart) return;
    }
